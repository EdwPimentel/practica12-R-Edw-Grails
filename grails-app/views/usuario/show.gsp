            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dt class="col-sm-3"><g:message code="rol.label"/></dt>
                        <dd class="col-sm-9">

                            <g:each var="cont" in="${usuarioRolList}">
                                <g:if test="${cont.usuario == this.usuario}">

                                    <g:if test="${cont.rol.toString() == "Rol(authority:ROLE_USER)"}">
                                        User
                                    </g:if>

                                    <g:if test="${cont.rol.toString() == "Rol(authority:ROLE_ADMIN)"}">
                                        Admin
                                    </g:if>
                ...
                <div class="card-footer">
                    <g:form resource="${this.departamento}" method="DELETE">
                        <g:link class="btn btn-primary btn-mini" action="edit" resource="${this.usuario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
